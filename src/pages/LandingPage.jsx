...
const LandingPage = () => {
  ...
  return (
    <div className="relative bg-black text-white font-sans overflow-x-hidden">
      ...
      {/* Navbar */}
      <nav className="flex justify-between items-center px-4 sm:px-8 md:px-16 py-6 fixed w-full z-50 backdrop-blur-lg bg-black/30 border-b border-white/10 shadow-md">
        <h1
          className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight bg-gradient-to-r from-fuchsia-400 via-blue-400 to-cyan-400 text-transparent bg-clip-text"
          style={neonGlow}
        >
      ...
      {/* Hero Section */}
      <section className="min-h-screen flex flex-col justify-center items-center text-center px-4 pt-40 relative z-10">
        <motion.h2
          initial={{ opacity: 0, scale: 0.8 }}
          whileInView={{ opacity: 1, scale: 1 }}
          transition={{ duration: 1, ease: "easeOut" }}
          viewport={{ once: true }}
          className="text-5xl sm:text-6xl md:text-8xl font-extrabold bg-gradient-to-r from-cyan-400 via-fuchsia-500 to-rose-500 bg-clip-text text-transparent tracking-tight"
          style={neonGlow}
        >
          KIIT Smart Campus
        </motion.h2>
        <motion.p
          ...
          viewport={{ once: true }}
          className="text-base sm:text-lg mt-6 max-w-2xl text-gray-300"
        >
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="w-52 h-52 sm:w-64 sm:h-64 mt-8"
        >
      ...
      {/* Final CTA */}
      <section className="py-24 sm:py-32 text-center bg-gradient-to-br from-[#0f172a]/50 to-[#1e293b]/50 relative z-10 border-t border-white/10 backdrop-blur-sm">
        <motion.h3
          initial={{ opacity: 0, scale: 0.95 }}
          whileInView={{ opacity: 1, scale: 1 }}
          transition={{ duration: 0.7 }}
          viewport={{ once: true }}
          className="text-4xl sm:text-5xl font-bold text-white px-4"
          style={neonGlow}
        >
        ...
        <motion.p
          ...
          transition={{ duration: 1, ease: "easeOut" }}
          viewport={{ once: true }}
          className="text-gray-400 mt-4 mb-8 text-lg px-4"
        >
        ...
        <motion.button
          ...
          viewport={{ once: true }}
          onClick={() => navigate("/login")}
          className="px-10 sm:px-12 py-3 sm:py-4 bg-gradient-to-r from-purple-500 to-blue-600 text-white text-base sm:text-lg font-semibold rounded-full hover:scale-105 hover:shadow-xl transition-all duration-300"
        >
          Get Started
        </motion.button>
      </section>
